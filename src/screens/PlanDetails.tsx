    ...
    return (
        <>
            <SafeAreaView className='flex-1 my-2'>
                    ...
                    <View className='flex flex-row space-x-2'>
                        {arrEmpty.length && (
                            <TouchableOpacity className='flex-row border-2 border-slate-400 w-[110px] px-2 py-[7px] mt-2 rounded-2xl justify-center items-center'>
                                <Text className='font-medium text-primary ml-[5px]'>
                                    {dateString}
                                </Text>
                            </TouchableOpacity>
                        )}
                        <TouchableOpacity
                            className='flex-row border-2 border-slate-400 w-[160px] px-2 py-[7px] mt-2 rounded-2xl justify-center items-center'
                        ...
                        {arr.length > 0 ? (
                            ...
                            <View className='flex items-center px-3'>
                                ...
                                <Text className='text-primary mb-2 text-center leading-5'>
                                    Tìm địa điểm du lịch và hoạt động giải trí, rồi nhấn vào để lưu
                                    các nội dung đó tại đây
                                </Text>
                            </View>
                        )}
                    </View>
                ...
                <TouchableOpacity
                    className='absolute bottom-0 right-5 bg-main p-4 rounded-full items-center justify-center mb-2'
