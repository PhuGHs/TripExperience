                ...
                <View className='space-y-4'>
                    ...
                    <View className='flex flex-row justify-between'>
                        ...
                        <View className='flex flex-row space-x-3'>
                            <TouchableOpacity
                                onPress={() =>
                                    navigation.push('ReviewScreen', { destinationId: 3 })
                                }
                    ...
                    <View className='flex flex-col space-y-2'>
                        ...
                        <Text className='text-lg text-secondary'>
                            Bến Thành Market is one of the most famous landmarks in Ho Chi Minh
                            City, Vietnam. It's located in District 1, at the intersection of Lê
                            Lợi, Hùng Vương, Lê Thánh Tôn, and Phan Chu Trinh streets. The market is
                            not just a commercial hub but also a historical symbol of the city's
                    ...
                    <View className='flex flex-col space-y-4'>
                        ...
                        <Text className='text-secondary text-lg'>
                            Cu Chi Near Benh Dinh Village, Thành phố Hồ Chí Minh
                        </Text>
                    </View>
                    <View className='items-center justify-center w-full h-[200px] rounded-xl'>
                        <MapView
                            style={styles.map}
                            region={{
                                latitude: 10.772706505028399,
                                longitude: 106.69805298228023,
