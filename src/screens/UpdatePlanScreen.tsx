        ...
        <SafeAreaView className='flex-1 my-2'>
            ...
            <ScrollView className='px-4'>
                ...
                <View className='mt-5'>
                    ...
                    <TextInput
                        className='border-[2px] border-[#B0A695] rounded px-3 py-2 text-primary font-bold'
                ...
                <View className='mt-5'>
                    ...
                    <TextInput
                        className='h-[120px] border-[2px] border-[#B0A695] rounded px-3 py-3 text-primary font-bold'
            ...
            <TouchableOpacity
                className='absolute inset-x-5 bottom-0 bg-main px-10 py-3 rounded-full items-center justify-center
            mb-2'
            >
