        ...
        <SafeAreaView className='flex flex-1 mx-4 mt-4'>
            <ScrollView className='h-full' showsVerticalScrollIndicator={false}>
                ...
                <SearchBar
                    ...
                    placeholder={
                        isLocationSearch ? 'Bạn muốn đi đâu?' : 'Bạn muốn tìm bài viết nào?'
                    }
                ...
                <View className='mb-4'>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item, index }) => (
                            <Group
                                press={() => {
                                    navigation.navigate('GroupDetailScreen', { groupId: 1 });
                                }}
                            />
                        )}
                    />
                ...
                <View className='mb-4'>
                    ...
                    {isLocation ? (
                        ...
                        <View className='px-5 py-5 bg-[#096C47] rounded-lg mt-5'>
                            <Text className='text-center font-bold text-white text-2xl mb-2'>
                                Xem địa điểm du lịch lân cận
                            </Text>
                            <View className='items-center mb-2'>
                                <TouchableOpacity
                                    className='border-2 border-white w-[150px] px-2 py-[7px] mt-2 rounded-2xl justify-center items-center'
