    ...
    return (
        <>
            <SafeAreaView className='flex flex-1 h-full w-full'>
                        ...
                        <View className='flex-col mt-5'>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    <Plan
                                        press={() => navigation.push('PlanDetails', { planId: 1 })}
                                    />
                                )}
                            />
                        </View>
                ...
                <TouchableOpacity
                    className='absolute inset-x-5 bottom-0 bg-main px-10 py-4 rounded-full items-center justify-center mb-2'
            ...
            <BottomSheet ref={sheetRef} height='43%'>
                <View className='h-full'>
                    ...
                    <View className='px-5 items-end'>
                        <TouchableOpacity
                            className='w-[120px] py-3 rounded-full items-center justify-center bg-main'
